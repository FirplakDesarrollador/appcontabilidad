...
export default function InvoicesPage() {
    ...
    const syncInvoices = async () => {
        ...
        try {
            ...
            if (data.success) {
                alert(data.message || 'Sincronizaci├│n con SharePoint completada.');
                fetchInvoices(true);
                fetchCounts();
            } else {
            ...
            alert('Error de conexi├│n con el servidor SharePoint.');
        } finally {
        ...
        <div className="min-h-screen bg-[#f8fafc] flex">
            ...
            <main className="flex-1 md:ml-64 relative bg-[#f8fafc]">
                ...
                <header className="h-20 bg-white/80 backdrop-blur-xl border-b border-gray-100 flex items-center justify-between px-6 sticky top-0 z-10">
                    <div className="font-semibold text-gray-800 text-lg">Aprobaci├│n de Facturas</div>
                    <div className="flex items-center gap-4">
                        ...
                        >
                            ...
                            <span className="hidden lg:inline">Aprobaci├│n Autom├ítica</span>
                        </button>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                        <div>
                            <div className="flex items-center gap-3">
                                <h1 className="text-3xl font-bold text-[#254153]">Gesti├│n de Facturas</h1>
                            ...
                            <p className="text-gray-500 mt-1">Sincronizaci├│n bidireccional con SharePoint Online</p>
                        </div>
                                        ...
                                        <tr>
                                            <td colSpan={7} className="px-6 py-12 text-center">
                                                <div className="flex flex-col items-center justify-center text-gray-400 gap-2">
                                                    ...
                                                    <p className="text-sm italic">No se encontraron facturas que coincidan con la b├║squeda.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    ) : (
                                ...
                                <div className="p-8 md:p-12">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 mb-12">
                                        ...
                                        <div className="col-span-full pt-4 border-t border-gray-50">
                                            <ModalInfoItem icon={<User />} label="Responsable" value={selectedInvoice.Responsable_de_Autorizar} subValue="Autoridad asignada para esta gesti├│n" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3 p-4 bg-white rounded-2xl border border-gray-100 shadow-sm">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] text-gray-500 font-medium leading-relaxed mt-0.5">
                                                Los proveedores activados aprobar├ín sus facturas autom├íticamente al ingresar.
                                            </p>
                                        </div>
                                    </div>
                                </div>
